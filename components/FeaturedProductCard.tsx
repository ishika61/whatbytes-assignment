...
//   className="mt-auto rounded-mdbg-[#005FBB] py-2 text-sm font-medium text-white transition hover:bg-[#004a92]"
//         >
//           Add to Cart
//         </button>
//       </div>
  ...
  return (
    <div className="flex flex-col gap-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:col-span-2 sm:flex-row">
      ...
      <div className="flex flex-col">
        ...
        <button
          onClick={() => addToCart(product)}
          className="mt-4 w-fit rounded-md bg-[#005FBB] px-6 py-2 text-sm font-medium text-white transition hover:bg-[#004a92]"
        >
          Add to Cart
        </button>
      </div>
